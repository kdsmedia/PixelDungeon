...
import com.altomedia.pixeldungeon.Rankings;
...
import com.altomedia.pixeldungeon.ui.Archs;
import com.altomedia.pixeldungeon.ui.ExitButton;
import com.altomedia.pixeldungeon.ui.Icons;
import com.altomedia.pixeldungeon.ui.Window;
import com.altomedia.pixeldungeon.windows.WndError;
import com.altomedia.pixeldungeon.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
  ...
  public void create() {
    ...
    if (Rankings.INSTANCE.records.size() > 0) {
      ...
      //attempts to give each record as much space as possible, ideally as 
      // much space as portrait mode
      float rowHeight = GameMath.INSTANCE.gate(ROW_HEIGHT_MIN, (uiCamera.height - 26)
              / Rankings.INSTANCE.records.size(), ROW_HEIGHT_MAX);
