...
import com.altomedia.pixeldungeon.QuickSlot;
...
import com.altomedia.pixeldungeon.ui.BadgesList;
import com.altomedia.pixeldungeon.ui.Icons;
import com.altomedia.pixeldungeon.ui.ItemSlot;
import com.altomedia.pixeldungeon.ui.PerkSlot;
import com.altomedia.pixeldungeon.ui.RedButton;
import com.altomedia.pixeldungeon.ui.ScrollPane;
...
public class WndRanking extends WndTabbed {
  ...
  private class StatsTab extends Group {
    ...
    private float statSlot(Group parent, String label, String value, float
      ...
      RenderedText txt = PixelScene.renderText(label, PixelScene.FONT_SIZE_BODY);
      txt.y = pos;
      parent.add(txt);
  ...
  private class ItemButton extends Button {
    ...
    protected void createChildren() {
      ...
      name = PixelScene.renderText("?", PixelScene.FONT_SIZE_BUTTON);
      add(name);
