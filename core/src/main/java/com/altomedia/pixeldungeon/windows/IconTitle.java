...
import com.altomedia.pixeldungeon.ui.HealthBar;
...
public class IconTitle extends Component {
  ...
  protected void layout() {
    ...
    tfLabel.setPos(imIcon.x + imIcon.width() + GAP, imIcon.height > tfLabel
            .height() ?
    ...
    if (health.visible) {
      health.setRect(tfLabel.left(), Math.max(tfLabel.top() + tfLabel.height
              (), imIcon.y + imIcon.height() - health.height()), tfLabel
              .maxWidth(), 0);
