...
public abstract class CustomTileVisual extends Image implements Bundlable {
  ...
  //bundleable offsets from the standard texture xy, useful for mapping 
  // larger than 1x1 textures to many tiles
  //(e.g. mapping a 3x3 texture to a room, where the corners are walls and 
  // the center is the floor)
