...
import com.altomedia.pixeldungeon.items.armor.curses.Multiplicity;
...
import com.altomedia.pixeldungeon.items.unclassified.BrokenSeal;
import com.altomedia.pixeldungeon.items.EquipableItem;
import com.altomedia.pixeldungeon.items.Item;
import com.altomedia.pixeldungeon.items.armor.curses.AntiEntropy;
import com.altomedia.pixeldungeon.items.armor.curses.Corrosion;
import com.altomedia.pixeldungeon.items.armor.curses.Displacement;
import com.altomedia.pixeldungeon.items.armor.curses.Metabolism;
import com.altomedia.pixeldungeon.items.armor.curses.Stench;
import com.altomedia.pixeldungeon.items.armor.glyphs.Affection;
import com.altomedia.pixeldungeon.items.armor.glyphs.AntiMagic;
import com.altomedia.pixeldungeon.items.armor.glyphs.Brimstone;
import com.altomedia.pixeldungeon.items.armor.glyphs.Entanglement;
import com.altomedia.pixeldungeon.items.armor.glyphs.Flow;
import com.altomedia.pixeldungeon.items.armor.glyphs.Obfuscation;
import com.altomedia.pixeldungeon.items.armor.glyphs.Potential;
import com.altomedia.pixeldungeon.items.armor.glyphs.Repulsion;
import com.altomedia.pixeldungeon.items.armor.glyphs.Stone;
import com.altomedia.pixeldungeon.items.armor.glyphs.Swiftness;
import com.altomedia.pixeldungeon.items.armor.glyphs.Thorns;
import com.altomedia.pixeldungeon.items.armor.glyphs.Viscosity;
...
public class Armor extends EquipableItem {
  ...
  @Override
  public String name() {
    return glyph != null && (cursedKnown || !glyph.curse()) ? glyph.name
...
//            1) - 1) / 2;
  ...
  public ItemSprite.Glowing glowing() {
    return glyph != null && (cursedKnown || !glyph.curse()) ? glyph.glowing()
            : null;
  }
  ...
  public static abstract class Glyph implements Bundlable {
    ...
    private static final Class<?>[] glyphs = new Class<?>[]{
            ...
            Brimstone.class, Viscosity.class, Entanglement.class, Repulsion
            .class, Camouflage.class, Flow.class,
