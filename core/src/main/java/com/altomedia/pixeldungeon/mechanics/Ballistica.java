 ...
 */
package com.altomedia.pixeldungeon.mechanics;
...
public class Ballistica {
  ...
  //note that the path is the FULL path of the projectile, including tiles 
  // after collision.
  //make sure to generate a subPath for the common case of going source to 
  // collision.
  ...
  public static final int STOP_TARGET = 1; //ballistica will stop at the 
  // target cell
  public static final int STOP_CHARS = 2; //ballistica will stop on first 
  // char hit
  public static final int STOP_TERRAIN = 4; //ballistica will stop on terrain
  // (LOS blocking, impassable, etc.)
