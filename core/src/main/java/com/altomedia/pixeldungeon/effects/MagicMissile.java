 ...
 */
package com.altomedia.pixeldungeon.effects;

import com.altomedia.pixeldungeon.DungeonTilemap;
import com.altomedia.pixeldungeon.effects.particles.ElectronParticle;
...
import com.altomedia.pixeldungeon.effects.particles.PoisonParticle;
...
import com.altomedia.pixeldungeon.effects.particles.WoolParticle;
...
public class MagicMissile extends Emitter {
  ...
  public static class MagicParticle extends PixelParticle {
    ...
    public static final Emitter.Factory ATTRACTING = new Factory() {
      @Override
      public void emit(Emitter emitter, int index, float x, float y) {
        ((MagicParticle) emitter.recycle(MagicParticle.class)).resetAttract
                (x, y);
      }
