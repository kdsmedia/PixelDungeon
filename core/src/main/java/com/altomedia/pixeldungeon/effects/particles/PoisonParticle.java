 ...
 */
package com.altomedia.pixeldungeon.effects.particles;
...
public class PoisonParticle extends PixelParticle {
  ...
  public static final Emitter.Factory MISSILE = new Factory() {
    ...
    public void emit(Emitter emitter, int index, float x, float y) {
      ((PoisonParticle) emitter.recycle(PoisonParticle.class)).resetMissile
              (x, y);
    }
  ...
  public static final Emitter.Factory SPLASH = new Factory() {
    @Override
    public void emit(Emitter emitter, int index, float x, float y) {
      ((PoisonParticle) emitter.recycle(PoisonParticle.class)).resetSplash(x,
              y);
    }
