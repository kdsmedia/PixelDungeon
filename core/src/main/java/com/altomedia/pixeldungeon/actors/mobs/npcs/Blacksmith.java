...
import com.altomedia.pixeldungeon.levels.diggers.unordinary.BlackSmithDigger;
import com.altomedia.pixeldungeon.levels.diggers.Digger;
import com.altomedia.pixeldungeon.windows.WndBlacksmith;
...
import com.altomedia.pixeldungeon.items.quest.DarkGold;
import com.altomedia.pixeldungeon.items.quest.Pickaxe;
...
import com.altomedia.pixeldungeon.sprites.BlacksmithSprite;
  ...
  public boolean interact() {
    ...
    if (!Quest.given) {
      ...
      GameScene.show(new WndQuest(this,
              Quest.alternative ? Messages.get(this, "blood_1") : Messages
                      .get(this, "gold_1")) {
