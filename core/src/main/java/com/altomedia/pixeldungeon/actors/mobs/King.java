...
import com.altomedia.pixeldungeon.items.unclassified.ArmorKit;
...
import com.altomedia.pixeldungeon.levels.CityBossLevel;
import com.altomedia.pixeldungeon.levels.Level;
import com.altomedia.pixeldungeon.sprites.UndeadSprite;
...
import com.altomedia.pixeldungeon.sprites.KingSprite;
...
public class King extends Mob {
  ...
  public void die(Object cause) {
    ...
    GameScene.bossSlain();
    Dungeon.level.drop(new ArmorKit(), pos).getSprite().drop();
    Dungeon.level.drop(new SkeletonKey(Dungeon.depth), pos).getSprite().drop();
    Dungeon.level.drop(new CrownOfDwarf(), pos).getSprite().drop();
