...
public abstract class OptionSlider extends Component {
  ...
  //values are expressed internally as ints, but they can easily be 
  // interpreted as something else externally.
  private int minVal;
  private int maxVal;
  ...
  public OptionSlider(String title, String minTxt, String maxTxt, int minVal,
                      int maxVal) {
    super();
